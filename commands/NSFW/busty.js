...
let settings = {
    ...
    usage: [
        {
            name: 'NOMBRE',
            description: 'Nombre de seins, default 1, max 5',
            optional: true
        }
    ],
}
...
module.exports = {
    ...
    execute: async(message, args) => {
        ...
        let posts = (await message.client.r.getSubreddit('BustyPetite').getTop({limit:100})).filter(post=>!post.stickied).map(post=>post.url);
